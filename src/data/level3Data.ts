...
export const level3Modules: Level3Module[] = [
  ...
  {
    id: 207,
    title: "Módulo 7: Generación de Video con IA (Prompts y Control)",
    duration: "60 min",
    description: "Diseña prompts estructurados para herramientas de generación de video con IA (como Runway Gen-2, Pika, Sora o Luma Dream Machine) logrando coherencia visual y control de cámara.",
    instructions: [
      "Define un concepto publicitario corto (ej. lanzamiento de producto, turismo, estilo de vida).",
      "Escribe al menos 3 prompts detallados para generar video. Cada prompt DEBE incluir: descripción de la escena, estilo visual, tipo de plano (ej. close-up, plano abierto, dolly shot), movimiento de cámara y duración estimada del clip.",
      "Genera los videos con la herramienta de tu preferencia (Runway, Pika, Sora, Luma, etc.) y documenta los resultados con capturas de pantalla o exportando los clips.",
      "Analiza los resultados: ¿Qué funcionó bien? ¿Qué ajustes harías a los prompts?",
      "Entrega un PDF o DOCX con los prompts, capturas/resultados y tu análisis. Puedes incluir un ZIP si adjuntas clips.",
    ],
    acceptedFormats: STANDARD_FORMATS,
  },
  {
